...
export default class LoginPage extends Component {
  ...
  getLoggedInStateFromStore(){
    return this.props.store.mystore.getState().LOGIN.isLoggedIn
  }
  updateStateFromStore() {
    var stateFromStore = this.props.store.mystore.getState();
    console.log("updateStateFromStore--------", stateFromStore);
    console.log(
      "updateStateFromStore--------",
      stateFromStore.LOGIN.isLoggedIn
    );
    this.setState ({ isLoggedin: stateFromStore.LOGIN.isLoggedIn });
  }
  componentDidMount() {
    this.unsubscribeStore = this.props.store.mystore.subscribe(
